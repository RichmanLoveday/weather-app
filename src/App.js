  ...
  render() {
    return (
      <div className="app" >
        ...
        {/* <button onClick={this.fetchWeather}>Get value</button> */}

        {this.state.isLoading && <p className="loader">Loading...</p>}

        {
          this.state.weather.weathercode && (this.state.error === false) && <Weather
        ...
        }
        {
          ...
          this.state.error === true && <p>LOCATION NOT FOUND</p>
        }
      </div >
    )
  }
